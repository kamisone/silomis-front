...
import { ArrowLeft, Image as ImageIcon, Plus, Timer } from "lucide-react";
      ...
      <div className={ui.pageHeader}>
        <div>
          ...
          <p className={styles.pageHint}>
            ...
            for a text slide on the brand gradient. Write each slide in English, then hit Generate on a field to fill
